  ...
  return (
    <div className="p-5 font-sans">
      <button onClick={() => setIsOpen(true)}
        className="w-48 bg-transparent hover:bg-blue-600 text-gray-700 font-mono py-2 rounded-xl transition duration-500 ease-in-out hover:scale-110 border-2 border-gray-700">
        Registrasi
      </button>
      {isOpen && (
        <div className="fixed inset-0 bg-black/50  justify-center items-center z-50 font-mono">
          <div className=" flex bg-black rounded-lg shadow-xl w-full max-w-full h-full max-h-full overflow-hidden p-5 ">
            <button onClick={() => setIsOpen(false)} className="absolute w-10 text-black bg-gray-400 hover:bg-gray-600 rounded-full">X</button>
            <div className=" md:flex w-1/2 bg-transparent flex items-center justify-center rounded-xl ">
            ...
            <div className="w-1/2 bg-white text-black grid m-0 gap-3 p-5 border-2 border-black  rounded-xl">
              ...
              <div className="relative w-full mb-1">
                ...
                <label htmlFor="Username"
                  className="absolute  left-4 top-4 -translate-y-1/2 text-black bg-white px-1 text-xs md:text-sm lg:text-base font-mono transition-all duration-200 pointer-events-none
                  peer-focus:-top-2.5 
                  peer-focus:text-sm
